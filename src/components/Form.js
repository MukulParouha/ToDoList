        ...
        return(
           <div className='p-3'>
                ...
                <div className="input-group mb-3 p-3">
                    ...
                    <button className="btn btnclr" type="button" id="button-addon2" onClick={this.handleAddTask}>Add Task</button>
                </div>
                ...
                <div className="mt-5">
                    ...
                    <div className="p-3">
                        ...
                        <div className="mx-auto m-3 " style={ {width: "150px"} }>
                        <button className="btn updatebutton" onClick={this.handleUpdateTask}> Update Task</button>
